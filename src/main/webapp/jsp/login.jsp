                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="height: 750px">
                        <div class="row" style="margin-top: 200px">
                            ...
                            <span id="lblUserName"
                                  class="input-group-addon" Style="width: 100px" >用户名：</span>
                                <input type="text" name="user_Name" id="txtUserName" value="${login.userName}" class="form-control" placeholder="Username" aria-describedby="basic-addon1"></input>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                                ...
                                <input type="text" name="user_Password" id="txtPassword" class="form-control" placeholder="Password" aria-describedby="basic-addon1"></input>
                            </div>
                        </div>
                        <br />
                        <div class="row" style="margin-bottom: 250px">
                            <div class="col-lg-6 col-lg-offset-3">
                                <input type="submit" id="btnSubmit" value="登录" class="btn btn-primary col-lg-12"/>
                            </div>
                        </div>
                    </div>
                </div>
