...
<head>
    ...
    <title>AirSystem-预订酒店</title>
    <link rel="stylesheet" href="http://cdn.static.runoob.com/libs/bootstrap/3.3.7/css/bootstrap.min.css">
</head>
<body>
<form id="hotelForm" method="post" action="/AirSystem/hotel/bill/book.html">
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="col-lg-2">
                ...
                <div>
                    <input type="button" id="btnBook" value="机票预订" class="btn btn-primary btn-block" onclick="javascript:location='/AirSystem/ticket/toBook.html'"/>
                    <br />
                    <p>使用该功能需要登录。</p>
                </div>
                <div>
            ...
            <div class="col-lg-10">
                <div class="panel panel-primary">
                    <div class="panel-title">
                        <div style="text-align: center; font-size: 24px">预订酒店</div>
                    </div>
...
<script src="${pageContext.request.contextPath}/js/bookhotel.js" type="text/javascript"></script>
</body>
</html>
