...
public class TicketController {
    ...
    @RequestMapping("/toBuy.html")
    public ModelAndView setTicketToBuy(String airCode, String startTime, String arriveTime, String theDateToBuy){
        ModelAndView modelAndView = new ModelAndView();
        Ticket ticket = ticketService.getTicketToBuy(airCode, startTime, arriveTime, theDateToBuy);
        modelAndView.addObject("ticket", ticket);
        modelAndView.setViewName("../../jsp/buy");
        return modelAndView;
    }
